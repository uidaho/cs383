...
\section{Use Case Diagrams}
    ...
    %\subsection{Project User Management (bolt1003)} 
    %    \includegraphics[width=\textwidth]{diagrams/usecase-usermanagement} <------ Remove?
    \subsection{Project Ideas (mars2681)}
    ...
    %\subsection{File Editing (snev7821)}
    %    \includegraphics[width=\textwidth]{diagrams/usecase-fileeditor} <------ Remove?
    %\subsection{Project File Management (snev7821)}
    %    \includegraphics[width=\textwidth]{diagrams/usecase-filemanagement}
...
% Formatting in this section needs to be revised to be consistent with the rest of the document
%##################################################################################################

\iffalse %<-- Remove when formatting is revised
...
\begin{tabular}{ p{2cm} p{12cm} }
 \hline \\
	...
	\textit{Task Category:} &    File Management \\
	\textit{Actor:} &   User \\ 
	\textit{Summary:} &  The user performs this task to create a new project. \\ 
	\\
	\textit{Preconditions:} &  User is logged in
	\textit{Steps:} &   \begin{enumerate}
	...
	\end{enumerate}\\ 
	\textit{Postconditions:} & \begin{enumerate}
		\item A new project is added to the project.
		\item The database is updated to reflect the changes.
	\end{enumerate}\\ \\
	\textit{Related:} & Add Existing File to Project, Add New File to Project
	\hline \\
\end{tabular}

\newpage

\subsubsection{Add New File to Project (snev7821)}
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	...
	\textit{Preconditions:} &  \begin{enumerate}
...
\subsubsection{Add Existing File to Project (snev7821)}
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\textit{Task Category:} &    File Management \\ 
	\textit{Actor:} &  User \\ 
...
\subsubsection{Delete File (snev7821)}
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\textit{Task Category:} &    File Management \\
	\textit{Actor:} &  User \\
...
\hline \\
	\textit{Task Category:} &   File Management \\
	\textit{Actor:} &  User \\
	\textit{Summary:} & The user performs this task to delete a project. \\
	\textit{Preconditions:} & \begin{enumerate}
		\item User must be registered.
		\item User must be logged in.
		\item User must have a project open.
	...
	\textit{Postconditions:} & \begin{enumerate}
		...
		\item The database is updated to reflect the changes.
	\end{enumerate}\\
		\textit{Related:} Delete File
\end{tabular} 
\newpage

\subsubsection{Export Project (snev7821)}
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\textit{Task Category:} &   File Management \\
	\textit{Actor:} &  User \\
	\textit{Summary:} & The user performs this task to download a project as a zip file. \\
	\textit{Preconditions:} & 
	\begin{enumerate}
		\item User must be registered.
		\item User must be logged in.
	...
	\end{enumerate}\\
	\textit{Related:} Export Files
\end{tabular}

\newpage

\subsubsection{Export Files (snev7821)}
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\textit{Task Category:} &   File Management \\
	\textit{Actor:} &  User \\
	...
	\end{enumerate}\\
	\textit{Alternatives:} & \begin{enumerate}
		\item Step 1: The user right clicks in the project panel and the system continues
 on to step 2 above.
...
\end{tabular}Task Category:} &  

\newpage

\subsubsection{Open File in New Tab (snev7821)}
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\textit{Category:} &   File Management \\
	\textit{Actor:} &  User \\
	\textit{Summary:} & Allows users to open a file. \\
	\textit{Purpose:} Opening files is essential in being able to work on a project. \\
	\textit{Preconditions:} &  \begin{enumerate}
	...
	\end{enumerate}\\	
	\textit{Alternatives:} Step 1: Instead of double clicking a file, the user right clicks it and navigates to \textit{Open}.
\end{tabular}
\newpage
...
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\textit{Category:} &    File Editing \\
	\textit{Actor:} &  User \\
	\textit{Summary:} & Allows the user to hide line numbers to the left of the document. \\
	\textit{Purpose:} In case user wants to hide line numbers so they have more space for text.\\
	\textit{Preconditions:} & 
	\begin{enumerate}
...
\hline \\
	...
	\textit{Purpose:} It is useful to know the number of references to a given function for optimization and debugging purposes. \\
	\textit{Preconditions:} &  \begin{enumerate}
		\item Must be registered.
		\item Must be logged in.
		\item User has view permission.
...
\hline \\
	...
	\textit{Purpose:} This provides a useful metric for how up-to-date parts of the document are. \\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered.
		\item Must be logged in.
		\item User has view permission.
...
\hline \\
	...
	\textit{Purpose:} This is an accountability tool allowing other users to identify who is responsible for a change to a document. \\
	\textit{Preconditions:} & 
	\begin{enumerate}
		\item Must be registered.
		\item Must be logged in.
...
\hline \\
	...
	\textit{Purpose:} An easy tool for making sweeping changes to a large part of a document. \\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered.
		\item Must be logged in.
...
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\textit{Task Category:} &   File Editing \\
	\textit{Actor:} &   User \\
	\textit{Summary:} &  Allows the user to find and/or replace phrases. \\
	\textit{Purpose:} & This is a powerful tool that allows a user to make safer, quicker, and more efficient changes to a document. \\
	\textit{Preconditions:} &  \begin{enumerate}
		\item Must be registered.
		\item Must be logged in.
		\item User has read/write permission.
...
\hline \\
	...
	\textit{Purpose:} A useful and quick way to disable a large part of a document. \\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered.
		\item Must be logged in.
		\item A file is open.
...
\hline \\
	...
	\textit{Purpose:} Differentiate who is typing what. \\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered.
		\item Must be logged in.
		\item User has read/write permission.
...
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\noindent\textit{Name:} View User Preferences \\
	\textit{Category:} &  User Preferences - Editor  \\
	\textit{Actor:} &  User \\
	\textit{Summary:} & User views their preferences and from here can change them \\
	\textit{Purpose:} Allows user to view their preferences and change them \\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered
		\item Must be logged in
	...
	\textit{Steps:} & \begin{enumerate}
		...
		\item System
 presents user with preferences page
	\end{enumerate}\\
...
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\noindent\textit{Name:} Modify Chat Font \\
	\textit{Category:} &  User Preferences - Editor  \\
	\textit{Actor:} &  User \\
	\textit{Summary:} & User changes the chat font \\
	\textit{Purpose:} Allows user to change what chat font they see for themselves and others \\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered
		\item Must be logged in
...
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\noindent\textit{Name:} Modify Chat Color \\
	\textit{Category:} &  User Preferences - Editor  \\
	\textit{Actor:} &  User \\
	\textit{Summary:} & User changes the chat color \\
	\textit{Purpose:} Allows user to change what chat color they see for themselves and others \\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered
		\item Must be logged in
		\item User is on user editor preferences page
...
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\noindent\textit{Name:} Edit User Editor Theme \\
	\textit{Category:} &  User Preferences - Editor  \\
	\textit{Actor:} &  User \\
	\textit{Summary:}User changes the Editor theme \\
	\textit{Purpose:} Allows user to change theme of the collaborative editor \\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered
		\item Must be logged in
		\item User is on user editor preferences page
	...
	\textit{Steps:} & \begin{enumerate}
		\item
 User clicks "Modify Editor Theme" button
...
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\noindent\textit{Name:} Turn Off Global Chat \\
	\textit{Category:} &  User Preferences - Editor  \\
	\textit{Actor:} &  User \\
	\textit{Summary:} & User turns off global chat \\
	\textit{Purpose:} Allows user to choose whether or not to engage in global chat \\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered
		\item Must be logged in
		\item User is on user editor preferences page
...
\begin{tabular}{ p{2cm} p{12cm} }
\hline \\
	\noindent\textit{Name:} Psuedo-offline Mode \\
	\textit{Category:} &  User Preferences - Editor  \\
	\textit{Actor:} &  User \\
	\textit{Summary:} & User changes to offline mode \\
	\textit{Purpose:} Allows user to turn off online features, including chat, public profiles, etc. Site then serves as basic editing environment\\
	\textit{Preconditions:} & \begin{enumerate}
		\item Must be registered
		\item Must be logged in
		\item User is on user editor preferences page
...
\newpage
\fi % <-- Remove when formatting is revised
% End Formatting
%##################################################################################################
...
\section{Authentication (mora5651)}
    \begin{minipage}{1\textwidth}
        \begin{center}
            \includegraphics[width=1\textwidth]{diagrams/class-authentication}
        \end{center}
        \captionof{figure}{Authentication is a security precaution in sQuire that allows the system to verify a user. Users will provide a username and password, and will be validated on the server-side.}
    \end{minipage}
...
\section{Project Management (mars2681)}
    \begin{minipage}{1\textwidth}
        \begin{center}
            \includegraphics[width=0.7\textwidth]{diagrams/sequence-authentication}
        \end{center}
        \captionof{figure}{Authentication authenticates stuff.}
    \end{minipage}
